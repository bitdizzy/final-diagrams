...
instance Monad repr => Proj1 (MonadicDiagram repr prim style ann) (a, b, c, d) a
instance Monad repr => Proj2 (MonadicDiagram repr prim style ann) (a, b, c, d) b
instance Monad repr => Proj3 (MonadicDiagram repr prim style ann) (a, b, c, d) c
instance Monad repr => Proj4 (MonadicDiagram repr prim style ann) (a, b, c, d) d
...
instance Monad repr => Tuple4 (MonadicDiagram repr prim style ann)
